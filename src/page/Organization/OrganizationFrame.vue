  ...
  <el-container style="border: 1px solid #eee; height: 100%">
        ...
        <el-col :span="20" class="header-row-col1">
          <el-row class="headerrow" type="flex" justify="left" align="middle">
            <el-button class="fold-button" @click="test" type="text">
              <i v-if="isCollapse" class="el-icon-s-unfold"></i><i v-else class="el-icon-s-fold"></i></el-button>
            <!-- <i class="el-icon-s-unfold" @click="test"></i> -->
            <img src="../../assets/tjlogo.png" class="logoImage" />

            <el-breadcrumb separator-class="el-icon-arrow-right">
              <el-breadcrumb-item v-for="(item, index) in breadList" :key="index" @click="this.$router.go(-1)">
    ...
    <el-container style="height: 100%">
      <el-aside style="width: auto">
        <el-menu class="el-menu-vertical-demo" default-active="/OrgFrame/Main" router active-text-color="#409EFF"
          ...
          <el-submenu index="">
            ...
            <el-menu-item-group>
              <el-menu-item index="/OrgFrame/CheckActivity/AllActivities">
      ...
      <el-main style="height: 100%; overflow: auto; background: rgb(237, 241, 245)">
        <keep-alive>
